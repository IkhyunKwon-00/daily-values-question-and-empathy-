...
import { Bell, House, PenLine, Search, UserRound, type LucideIcon } from "lucide-react";
...
function SideTab({
  ...
  return (
    <Link
      ...
      title={label}
      className={`group flex h-16 min-w-14 flex-col items-center justify-center gap-1 rounded-lg px-2 text-[10px] font-medium transition lg:h-12 lg:w-full lg:flex-row lg:justify-start lg:gap-3 lg:px-4 lg:text-sm ${
        active
