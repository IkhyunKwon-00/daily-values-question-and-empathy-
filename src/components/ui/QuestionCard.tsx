  ...
  return (
    ...
    >
      ...
      <div className="mb-5 flex items-center gap-2">
        ...
        {category && <span className="ml-auto text-xs text-ink-soft">{category}</span>}
      </div>
      <h2 className="max-w-[24ch] text-[clamp(1.65rem,6vw,2.4rem)] font-bold leading-[1.3] text-ink">
        {question}
      </h2>
